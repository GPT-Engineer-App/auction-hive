        ...
        <Box key={product.id} p={5} shadow="md" borderWidth="1px">
          <Flex align="center">
            ...
            <Stack>
              ...
              <Text>Starting Bid: ${product.startingBid}</Text>
              <Text>Buy Now: ${product.fixedPrice}</Text>
              <Flex align="center">
              ...
              <Text fontWeight="bold">Highest Bid: ${bids[product.id] || product.startingBid}</Text>
            </Stack>
          </Flex>
        </Box>
      ))}
